    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <center>
            <div class="row">
                ...
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="circular--square foto1" width="150px" src="@/assets/fotoDiego.jpg"><span class="font-weight-bold">Diego Iriarte</span><span class="text-black-50">edogaru@mail.com.my</span><span> </span></div>
                </div>
            </div>
        </center>
    </div>
